...
public class ApiHandler {
     ...
     * @return
     */
    public static byte[] transfer(ChannelHandlerContext ctx, FullHttpRequest msg) {
    ...
    public static Object invoke(String apiName, ApiProtocol apiProtocol) {
        ...
        try {
            classname = Class.forName(ConfigUtil.getString("resource.package.name") + "." + api.getResource());
